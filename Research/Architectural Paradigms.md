...
| :---- | :---- | :---- | :---- |
| Wave 1 | IVR Foundations | Rigid, rule-based systems; clunky and often frustrating for users (Maxitech, 2025) | Established the enterprise demand for voice-based automation (Maxitech, 2025) |
| Wave 2 | ASR/STT Breakthrough | Democratization of transcription (e.g., OpenAI’s Whisper); focus on accuracy (Maxitech, 2025) | Proven strategic value of voice data; shift toward production-grade accessibility (Maxitech, 2025) |
| Wave 3 | Generative Voice/Zero UI | Native audio LLMs; sub-300ms latency; human-like cadence and emotional nuance (Maxitech, 2025) | Shift from transcription to true interaction; integration of tone and prosody (Maxitech, 2025) |
...
| :---- | :---- | :---- |
| Audio Encoder | SenseVoice-large | Provides robust representations for multilingual ASR and audio event detection (SpeakerLM: End-to-end versatile speaker diarization and recognition, 2025) |
| Embedding Extractor | ERes2NetV2 | State-of-the-art model for precise speaker characteristic extraction (SpeakerLM: End-to-end versatile speaker diarization and recognition, 2025) |
| LLM Backbone | Qwen2.5-7B-Instruct | Processes audio, text, and speaker tokens concurrently for reasoning and generation (SpeakerLM: End-to-end versatile speaker diarization and recognition, 2025) |
| Projector | Two-layer Transformer | Aligns audio and speaker features with the LLM’s feature space (SpeakerLM: End-to-end versatile speaker diarization and recognition, 2025) |
...
| :---- | :---- | :---- |
| Cadence and Rhythm | The pace and timing of speech, including pause frequency (AI generated synthetic identities in FinTech: Detecting deep fakes KYC fraud using behavioral biometrics, n.d.) | Highly idiosyncratic; difficult for real-time deepfakes to mimic perfectly (Pitch: AI-assisted tagging of deepfake audio calls using challenge-response, 2024) |
| Pitch Variation | The dynamic range and "melody" of a user's speech (AI generated synthetic identities in FinTech: Detecting deep fakes KYC fraud using behavioral biometrics, n.d.) | Reflects physiological constraints and habitual speaking patterns (The age of sensorial zero trust: Why we can no longer trust our senses, 2025) |
| Syllable Elongation | The specific way a user stretches certain vowel sounds (AI generated synthetic identities in FinTech: Detecting deep fakes KYC fraud using behavioral biometrics, n.d.) | Often tied to regional accents and personal linguistic habits (The voice clone crisis: How AI scammers can steal your voice in 15 seconds, n.d.) |
| Vocal Jitter and Shimmer | Small, involuntary fluctuations in pitch and loudness (AI generated synthetic identities in FinTech: Detecting deep fakes KYC fraud using behavioral biometrics, n.d.) | A biological signature that serves as a liveness check against clones (AI generated synthetic identities in FinTech: Detecting deep fakes KYC fraud using behavioral biometrics, n.d.) |
...
| :---- | :---- | :---- |
| GPS/Geomagnetic Sensing | Indoor and outdoor location tracking for "Loco-Radio" audio browsing (Signature redacted, n.d.) | High-density audio maps that adapt to the user's moving mode (walking, driving) (Signature redacted, n.d.) |
| 3D Audio (Spatial Audio) | Allows users to perceive sound from specific directions and distances (Investigating the benefits and operational gaps of 3D spatial audio technology in aircraft, 2025) | Enhanced situational awareness and communication in multi-channel environments (Investigating the benefits and operational gaps of 3D spatial audio technology in aircraft, 2025) |
| Real-time 3D Reconstruction | Sonification of the environment (e.g., EchoSee) for navigation (EchoSee: An assistive mobile application for real-time 3D environment reconstruction and sonification supporting enhanced navigation for people with vision impairments, n.d.) | Dynamic placement of "virtual speakers" in a digital map of the world (EchoSee: An assistive mobile application for real-time 3D environment reconstruction and sonification supporting enhanced navigation for people with vision impairments, n.d.) |
| Trajectory Prediction | Inferring hidden or privately visited locations through AHLTP models (Efficient trajectory prediction using check-in patterns in location-based social network, n.d.) | Reconstructing a complete movement history to predict future needs (Efficient trajectory prediction using check-in patterns in location-based social network, n.d.) |
...
| :---- | :---- | :---- |
| Syntiant NDP120 | Under 140 $\mu W$ power draw; continuous audio streaming (Mordor Intelligence, n.d.) | Smart sensors, hearables, and health monitoring (Mordor Intelligence, n.d.) |
| Ambiq Apollo4/5 | Minimal power consumption; supports high-performance AI (Frost & Sullivan, 2025) | Hearing aids, smartwatches, and Edge-AI development (Frost & Sullivan, 2025) |
| Airoha AB1595 | Below 20ms round-trip latency; eliminates cloud dependency (Mordor Intelligence, n.d.) | Bluetooth headsets and real-time translation (Mordor Intelligence, n.d.) |
| Qualcomm Voice Assist | Almost-instant voice wake-up; dedicated audio hardware (Qualcomm, n.d.) | Mobile platforms and hi-fi audio experiences (Qualcomm, n.d.) |
...
| :---- | :---- | :---- |
| Deepfake Volume Increase | 3,000% growth between 2022 and 2023 (Pitch: AI-assisted tagging of deepfake audio calls using challenge-response, 2024) | Entrust data on identity fraud (Pitch: AI-assisted tagging of deepfake audio calls using challenge-response, 2024) |
| Attempt Frequency | One attempt every five minutes (Pitch: AI-assisted tagging of deepfake audio calls using challenge-response, 2024) | Pervasiveness of automated deepfake tools (Pitch: AI-assisted tagging of deepfake audio calls using challenge-response, 2024) |
| Total Fraud Losses | $43 billion in identity fraud losses (Pitch: AI-assisted tagging of deepfake audio calls using challenge-response, 2024) | Impact of synthetic identities in FinTech (Pitch: AI-assisted tagging of deepfake audio calls using challenge-response, 2024) |
| Victim Rate | 9% of Americans reported falling victim to deepfake scams (Pitch: AI-assisted tagging of deepfake audio calls using challenge-response, 2024) | General public vulnerability to voice cloning (Pitch: AI-assisted tagging of deepfake audio calls using challenge-response, 2024) |
...
| :---- | :---- | :---- |
| Onboarding ($S\_{onboard}$) | Concept introduction | Introducing privacy concepts before full system immersion (Mansour, 2025) |
| Contextual Prompts ($S\_{prompt}$) | Just-in-time consent | Obtaining explicit consent for sensitive data without overwhelming the user (Mansour, 2025) |
| In-Experience Transparency | Real-time feedback | Using icons or haptic signals to indicate when sensors are active (Mansour, 2025) |
| Post-Experience Review | Reflection and control | Allowing users to review and delete data shared during a session (Mansour, 2025) |
